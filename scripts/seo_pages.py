...
PAGES = {
    ...
    "/learn/install/": {
        "title": "Grok Bot download: Mac install and Cursor login",
        "description": "Official Grok Bot download and Mac install: Apple silicon vs Intel, Cursor login, App Store, and Google Play. This handbook is not the store.",
        "h1": "Download and install Grok Bot on Mac, then log in",
        "primary": "grokbot download; grok bot download; grokbot mac download; grokbot install",
        "also": "grok bot login; grok bot ios; grok bot android",
    ...
    "/pricing/": {
        ...
        "description": "Grok Bot pricing: paid Cursor plans include it, SuperGrok can link, and the early-September enterprise two-week trial is dated. No invented list prices.",
    ...
    "/troubleshooting/": {
        "title": "Grok Bot not working: stuck, can't reach, Recover vs Reset",
        "description": "Grok Bot not working, not responding, stuck, or stopped working? Recover vs Reset, can't reach your computer, silent bots, DNS, and antivirus.",
        "h1": "Grok Bot not working — Recover vs Reset if stuck or not responding",
        "primary": "grok bot not working; not responding; stuck; stopped working; can't reach",
        "also": "recover vs reset; silent bots; dns; antivirus",
