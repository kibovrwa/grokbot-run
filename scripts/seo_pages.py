...
PAGES = {
    ...
    "/learn/install/": {
        "title": "Grok Bot download: official install and Cursor login",
        "description": "Official Grok Bot download for Mac, Windows, Linux, iPhone, and Android. Cursor login, the right package, and where to go if setup sticks.",
    ...
    "/learn/mac-download/": {
        "title": "Grok Bot Mac download: Apple silicon or Intel",
        "description": "Download Grok Bot for Mac from x.ai/bot. Apple silicon versus Intel, Gatekeeper, Applications, Cursor login, and the white-screen fix.",
        "h1": "Download Grok Bot for Mac: Apple silicon or Intel",
    ...
    "/learn/windows-download/": {
        "title": "Grok Bot Windows download: x64, Arm64, and setup",
        "description": "Install Grok Bot on Windows from x.ai/bot. Choose x64 or Arm64, keep one copy, quit the tray, and fix proxy or Zscaler blocks.",
    ...
    "/learn/login/": {
        "title": "Grok Bot login: sign in with Cursor, no new account",
        "description": "Grok Bot has no separate account. Sign in with the Cursor account that holds the plan, fix a stuck browser popup, and clear a stale session.",
    ...
    "/troubleshooting/": {
        "title": "Grok Bot not working: stuck, silent, or can't reach",
        "description": "Grok Bot not working, stuck, or not responding? Open the matching fix: weekly usage, DNS, a white screen, or Recover versus Reset.",
        "h1": "Grok Bot not working — pick the symptom before you Reset",
    ...
    "/troubleshooting/not-responding/": {
        "title": "Grok Bot not responding or stopped working",
        "description": "Grok Bot not responding while the computer still opens is often weekly usage. Check the meter before Recover or Reset. On-Demand is optional.",
        "h1": "Grok Bot not responding or stopped working",
    ...
    "/troubleshooting/stuck/": {
        "title": "Grok Bot stuck on Connecting, Setting up, or Reconnecting",
        "description": "Grok Bot stuck on Connecting, Setting up, Cleaning up, or 50 percent Starting? Privacy Mode, a missing seat, and when waiting beats Reset.",
        "h1": "Grok Bot stuck on Connecting, Setting up, or Reconnecting",
    ...
    "/troubleshooting/cant-reach/": {
        "title": "Grok Bot can't reach your computer: DNS, VPN, antivirus",
        "description": "Cannot reach your computer in Grok Bot is often DNS, a VPN, or antivirus HTTPS scanning. Test a phone hotspot first. Recover before Reset.",
    ...
    "/troubleshooting/white-screen/": {
        "title": "Grok Bot white screen or black screen after install",
        "description": "Grok Bot white screen, black spinner, or empty roster after install. Clear the Mac config folder, wait out sleep, and do not Reset a waking computer.",
        "h1": "Grok Bot white screen, black screen, or empty roster",
    ...
    "/troubleshooting/recover-vs-reset/": {
        "title": "Grok Bot Recover vs Reset: which button to use",
        "description": "Grok Bot Recover, Update, or Reset: what each one keeps, why Reset is last, and the fake hangs at Cleaning up and 50 percent Starting.",
        "h1": "Recover, Update, or Reset the Grok Bot computer",
