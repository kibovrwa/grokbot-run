...
PAGES = {
    ...
    "/learn/install/": {
        "title": "Download Grok Bot: official Mac, Windows, Linux, and phone",
        "description": "Official Grok Bot download from x.ai/bot. The top Mac button is Apple silicon; Intel is under More downloads. Then sign in with Cursor.",
        "h1": "Download and install Grok Bot, then sign in with Cursor",
        "primary": "grokbot download; grok bot download; grokbot install",
        "also": "official desktop download; linux package",
        "do_not": "mac-only chip steps; windows tray; phone stores; login popup bugs",
    },
    "/learn/mac-download/": {
        "title": "Grok Bot Mac download: Intel is under More downloads",
        "description": "The top macOS button on x.ai/bot is Apple silicon. Intel is under More downloads. Drag to Applications, choose Open, then sign in with Cursor.",
        "h1": "Download Grok Bot for Mac: the top button is Apple silicon",
        "primary": "grok bot mac download; grokbot mac download; download grok bot for mac",
        "also": "apple silicon; intel; gatekeeper",
        "do_not": "windows installer; iphone app store; weekly usage",
    },
    "/learn/windows-download/": {
        "title": "Grok Bot Windows download and the direct-connection test",
        "description": "Install Grok Bot for Windows from x.ai/bot. Pick x64 or Arm64, keep one copy, and run the staff connection test if the app ignores your proxy.",
        "h1": "Download and install Grok Bot on Windows",
        "primary": "grok bot windows download; grok bot windows install",
        "also": "x64; arm64; tray quit; system proxy",
        "do_not": "mac chip choice; phone stores",
    },
    "/learn/phone-download/": {
        "title": "Grok Bot iPhone and Android download (official stores)",
        "description": "Download Grok Bot for iPhone, iPad, and Android from the official stores. What syncs after Cursor login, and what still requires the desktop app.",
        "h1": "Download Grok Bot for iPhone, iPad, and Android",
        "primary": "grok bot ios download; grok bot android; grok bot app",
        "also": "ipad; app store; google play",
        "do_not": "desktop dmg; reset computer",
    },
    "/learn/login/": {
        "title": "Grok Bot login: finish Cursor in the browser, then return",
        "description": "Sign-in fails when the app loses the browser. Keep Grok Bot open, confirm Cursor succeeded, return manually, and fix Legacy Privacy Mode before Reset.",
        "h1": "Sign in to Grok Bot with your Cursor account",
        "primary": "grok bot login; grokbot sign in; sign in with cursor",
        "also": "sso; privacy mode; stale session",
        "do_not": "cursor ide panel (cursor page); plan price list",
    },
    "/learn/first-bot/": {
    ...
    "/troubleshooting/": {
        "title": "Grok Bot not working? Quit, Retry, then match the screen",
        "description": "Grok Bot not working: fully quit, choose Retry, and do not Reset while it reconnects. Then match usage, DNS, a white screen, or a hidden Bot.",
        "h1": "Grok Bot not working — quit and Retry before you Reset",
        "primary": "grok bot not working",
        "also": "symptom index; where to start",
        "do_not": "the long walkthroughs for one symptom",
    },
    "/troubleshooting/not-responding/": {
        "title": "Grok Bot not responding: check the computer, then usage",
        "description": "A bot cannot answer while the computer says Reconnecting. If the computer is up and bots are silent, check weekly usage before Recover or Reset.",
        "h1": "Grok Bot not responding: computer first, then usage",
        "primary": "grok bot not responding; grok bot stopped working; bot failed to respond",
        "also": "silent bots; weekly usage; on-demand",
        "do_not": "dns can't reach; white screen; install steps",
    },
    "/troubleshooting/stuck/": {
        "title": "Grok Bot stuck on Setting up? Wait if it is still moving",
        "description": "If Starting your computer is still changing, wait. If it stops: Retry, restart, update the app, then update the computer. Reset is last.",
        "h1": "Grok Bot stuck on Setting up, Starting, or Connecting",
        "primary": "grok bot stuck; stuck on setting up; stuck connecting",
        "also": "cleaning up; 50 percent starting; privacy mode",
        "do_not": "weekly usage silence; mac dmg steps",
    },
    "/troubleshooting/cant-reach/": {
        "title": "Can't reach your computer in Grok Bot? Retry, then DNS",
        "description": "Could not reach Grok Bot's computer: Retry and quit before Reset. If it persists, test a hotspot, wildcard DNS, and the Windows direct-connection check.",
        "h1": "Can't reach your computer in Grok Bot",
        "primary": "can't reach your computer; grok bot reconnecting; cursorvm dns",
        "also": "hotspot; antivirus ssl; vpn",
        "do_not": "silent bots with computer visible; white window config",
    },
    "/troubleshooting/white-screen/": {
        "title": "Grok Bot white screen or missing bots: check Hidden Bots",
        "description": "A white screen can be local config. Missing bots are often hidden or on another device. Do not Reset to look for chats. Chats live outside the computer.",
        "h1": "Grok Bot white screen, empty roster, or hidden bots",
        "primary": "grok bot white screen; grok bot black screen; empty roster",
        "also": "application support; setting up spinner",
        "do_not": "dns walkthrough; recover vs reset table",
    },
    "/troubleshooting/recover-vs-reset/": {
        "title": "Grok Bot Update vs Recover vs Reset: what each removes",
        "description": "Update and Recover keep synced bots and files but remove installed apps. Reset can drop unsynced work. Backup not ready means wait, not Reset.",
        "h1": "Update, Recover, or Reset Grok Bot's computer",
        "primary": "grok bot reset; grok bot recover; update agent computer",
        "also": "cleaning up; last resort",
        "do_not": "usage meter; download packages",
    },
    "/learn/": {
